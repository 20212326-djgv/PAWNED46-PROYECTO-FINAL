...
Public Class rptHistorialPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAWNED46_project.rptHistorialPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHistorialPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHistorialPagos = New rptHistorialPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
