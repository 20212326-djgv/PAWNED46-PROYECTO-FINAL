...
Public Class rptContratoPrestamo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptContratoPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAWNED46_project.rptContratoPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContratoPrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContratoPrestamo = New rptContratoPrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
