...
Public Class rptRenovacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAWNED46_project.rptRenovacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRenovacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRenovacion = New rptRenovacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
